...
<head>
    ...
    <link href="css/style.css" rel="stylesheet"><!-- HTML5 Shim and Respond.js IE8 support of HTML5 elements and media queries -->
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                <button class="navbar-toggle" data-target="#bs-example-navbar-collapse-1" data-toggle="collapse" type="button"><span class="sr-only">Toggle navigation</span> <span class="icon-bar"></span> <span class="icon-bar"></span> <span class="icon-bar"></span></button> <a class="navbar-brand" href="#">Start Bootstrap</a>
            </div>
                ...
                <div class="modal-body">
                    <form action="controller/register.php" autocomplete="off" class="form-horizontal" id="register-form" method="post" name="register-form" onsubmit="return CheckRegistrationForm(this);" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input autocomplete="off" class="form-control" id="password"  name="password" placeholder="Password" tabindex="1" type="password" value="" ><span class="" id="passwordError"></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input autocomplete="off" class="form-control" id="passwordCheck" name="passwordCheck" placeholder="Repeat password" tabindex="1" type="password" value=""><span class="" id="passwordCheckError"></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-sm-6 col-sm-offset-3">
                                    <input class="form-control btn btn-register" id="register-submit" name="register-submit" tabindex="4" type="submit" value="Register Now">
                                </div>
                            </div>
                        </div>
                    </form>
                ...
                <div class="modal-body">
                    <form action="controller/login.php" autocomplete="off" class="form-horizontal" id="login-form" method="post" name="login-form" onsubmit="return CheckLoginForm(this);" role="form">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input autocomplete="off" class="form-control" id="emailLogin" maxlength="256" name="emailLogin" oncopy="return false" onpaste="return false" placeholder="Email" required="" tabindex="1" type="email" value=""> <span class="" id="emailLoginError"></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-sm-6 col-sm-offset-3">
                                    <input class="form-control btn btn-login" id="login-submit" name="login-submit" tabindex="4" type="submit" value="Login">
                                </div>
                            </div>
                        </div>
                    </form>

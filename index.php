                ...
                <form action="controller/register.php" autocomplete="off" class="form-horizontal" id="register-form"
                    ...
                    <div class="password-requirements">
                        <ul>
                            ...
                            <li>use at least 1 uppercase character (A-Z)</li>
                            <li>use at least 1 lowercase character (a-z)</li>
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-sm-offset-3">
                                <input class="form-control btn btn-register btn-success" id="register-submit"
                                       name="register-submit" tabindex="4" type="submit" value="Register Now">
                            </div>
                        </div>
                    </div>
                </form>
            ...
            <div class="modal-body">
                <form action="controller/login.php" autocomplete="off" class="form-horizontal" id="login-form"
                    ...
                    <div class="form-group">
                        <div class="col-sm-12 ">
                            <div class="checkbox">
                                <label><input type="checkbox" class="checkbox-primary" name="rememberCb">Remember
                                    me</label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-sm-offset-3">
                                <input class="form-control btn btn-login btn-success" id="login-submit"
                                       name="login-submit" tabindex="4" type="submit" value="Login">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-12">
                ...
                <p>
                    Air Quick makes it easy to store, share and access your files from anywhere, anytime. We create
                    product that is easy to use and is built on trust. Our users’ privacy has always been our first
                    priority, and it always will be.

                </p>
                <button id="btn-register" class="btn-intro"><a data-target="#registerModal" data-toggle="modal"
                                                               href="#">Register</a></button>
                <span>&nbsp; </span><span>&nbsp; </span>
                <button id="btn-login" class="btn-intro"><a data-target="#LoginModal" data-toggle="modal"
                                                            href="#">Login</a></button>
                <div class="col-sm-12">
        ...
        <div class="row">
            ...
            <div id="one">
                <div class="about-container col-lg-4 col-md-6 col-sm-12">
                    ...
                    <p>
                        Lorem ipsum dolor sit amet, soluta fabellas sententiae et pro. Ei mazim nominavi mediocritatem
                        sea, nec alterum appareat an.
                    </p>
                </div>
            </div>
            <div id="two">
